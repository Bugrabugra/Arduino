...
const char ssid[] = "KAT3";    // Network SSID (name)
const char pass[] = "UnV-2019!Wf++";    // Network password (use for WPA, or use as key for WEP)
const String discord_webhook = "api/webhooks/625928948169310229/sYAJu45h5NuQHT4pfzokIak0iyvbV_pL_2tUMYe2Mj0xdsvUTeHaAmwezM7rhj8vSjXt";
