...
int x = 0;
int y = 0;  // randomly named variables in order to controll button pressed or not
int son = 0;
int son2 = 0;
int son3 = 0;  // randomly named variables in order to controll button pressed or not
int diger = 1;
int diger2 = 1;
int diger3 = 1;  //  randomly named variables in order to controll button pressed or not
