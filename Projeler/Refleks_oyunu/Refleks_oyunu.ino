...
void loop()
{
  if (welcomeMsg == false)
  {
    ...
    display.print("Mavinin puani: "); display.print(scoreBlue);
    display.setCursor(0, 50);
    display.print("Kirmizinin puani: "); display.print(scoreRed);
...
void endGame()
{
  ...
  display.clearDisplay();
  display.setCursor(0, 20);
  display.print("Mavinin hizi: "); display.print(finalTimeBlue / 1000);
  display.setCursor(0, 40);
  display.print("Kirmizinin hizi: "); display.print(finalTimeRed / 1000);
  display.display();
  ...
  if (endTimeBlue < endTimeRed) //Mavi kazandıysa
  {
    ...
    display.setCursor(0, 40);
    display.print(winningTime / 1000); display.print("saniye");
    display.display();
    delay(3000);
  }
